...
const countriesHolidays: Record<string, CountryInfo> = {
  ...
  'eg': {
    ...
    holidays: {
      ...
      2029: [
        ...
        { name: 'Eid al-Fitr', nameAr: 'عيد الفطر', date: '2029-02-15', type: 'religious', duration: 3 },
        { name: 'Sham el-Nessim', nameAr: 'شم النسيم', date: '2029-04-09', type: 'national' },
      ...
      2030: [
        ...
        { name: 'Eid al-Fitr', nameAr: 'عيد الفطر', date: '2030-02-04', type: 'religious', duration: 3 },
        { name: 'Sham el-Nessim', nameAr: 'شم النسيم', date: '2030-04-29', type: 'national' },
  ...
  'ma': {
    ...
    holidays: {
      ...
      2030: [
        ...
        { name: 'Independence Day', nameAr: 'عيد الاستقلال', date: '2030-11-18', type: 'national' }
      ]
    }
  },
  ...
  'ly': {
    ...
    holidays: {
      ...
      2029: [
        { name: 'Revolution Day (17 February)', nameAr: 'ثورة 17 فبراير', date: '2029-02-17', type: 'national' },
        { name: 'Eid al-Fitr', nameAr: 'عيد الفطر', date: '2029-02-15', type: 'religious', duration: 3 },
        { name: 'Eid al-Adha', nameAr: 'عيد الأضحى', date: '2029-04-24', type: 'religious', duration: 4 },
        { name: 'Islamic New Year', nameAr: 'رأس السنة الهجرية', date: '2029-05-15', type: 'religious' },
      ...
      2030: [
        { name: 'Revolution Day (17 February)', nameAr: 'ثورة 17 فبراير', date: '2030-02-17', type: 'national' },
        { name: 'Eid al-Fitr', nameAr: 'عيد الفطر', date: '2030-02-04', type: 'religious', duration: 3 },
        { name: 'Eid al-Adha', nameAr: 'عيد الأضحى', date: '2030-04-13', type: 'religious', duration: 4 },
        { name: 'Islamic New Year', nameAr: 'رأس السنة الهجرية', date: '2030-05-04', type: 'religious' },
